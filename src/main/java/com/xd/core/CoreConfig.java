...
/**********************************推送（个推）相关**************************************************************/	
	 ...
	 * 个推appId
	 */
//	public static final String APP_ID = "zyyO4YkhqYANlyecm2K6M";  //综合版
//	public static final String APP_ID = "88UIWJsllb8TXq93jCi3J";  //EP2版
	public static final String APP_ID = "Vkz6VWW3qS6HUI3H6JTQfA";  //平台版
	/**
	 * 个推appKey
	 */
//	public static final String APP_KEY = "OzyCNgdDpW5kszut1SaPV4";  //综合版
//	public static final String APP_KEY = "TVRDS9vOvC9Tyl6d7jqMr4";  //EP2版
	public static final String APP_KEY = "dtuT1VGziB7mpdNNlRgDh8";  //平台版
	/**
	 * 个推masterSecret
	 */
//	public static final String MASTER_SECRET = "hZIsHk0LMkAiS2n9hCgzX6"; //综合版
//	public static final String MASTER_SECRET = "SfzK38TiJR7bOvSMEt4O23"; //EP2版
	public static final String MASTER_SECRET = "ZLhjCHSNzrAFGL15vFciJ6"; //平台版
